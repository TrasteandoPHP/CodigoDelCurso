...
<?php
    ...
    if($conexion->query($sqlconsultaprestamo)->fetch_array())
    {
        ...
        $sqldevolucion="SELECT * FROM prestamos INNER JOIN libros ON prestamos.cod_lib=libros.cod_lib";
...
<?php
    ...
    else
    {
        ...
        if($conexion->query($sqlconsultareser)->fetch_array())
        {
            ...
            $sqlreserva="SELECT * FROM prestamos INNER JOIN libros ON prestamos.cod_lib=libros.cod_lib";
...
?>
            ...
            <label for="" style="color:red">Tienes reservado préstamo de otro libro pendiente recoger. Titulo: <?php echo $tituloreserva?>, fecha reserva: <?php echo $fechareserva?></label>
            <br><br>
...
<?php
        ...
        else
        {
            ...
            {
                //Libro disponible (disponible_lib=0)       
?>
...
<?php
            ...
            {
                //Libro no disponible (disponible_lib=1)
                ...
                {
                    //El libro ha sido reservado por el usuario y no ha sido entregado, no ha sido recogido
?>
...
?>            
                    <button onclick="">LIBRO NO DISPONIBLE</button>    
<?php
                }        
    ...
    {
        //El usuario ya tiene este libro como favorito
?>
...
<?php
    ...
    {
        //El usuario no tiene este libro como favorito y lo puede añadir a favorito
?>
...
?>     
    <!-- Etiquetas input's para las variables código libro y código usuario 
