...
foreach($recibe as $registro){
	...
	if($registro["disponible_lib"] == 0)
	{
		//Libro disponible
		echo'
			<article style="display:flex; flex-direction:column; align-items:center; flex-wrap:wrap; width:350px">
				<a href="verlibro.php?codlib='.$registro["cod_lib"].'" class="image">
					<img src="./../images/portadas/'.$registro["cod_lib"].'/'.$registro["imagen_lib"].'" alt="" style="height:500px; width:350px"/>
				</a>
						...
						<div class="inner">
							...
							<!-- Menu -->
								...
								<section>
									...
									<ul class="contact">
										<li class="icon solid fa-envelope">administracion@bookbusters.es</li>
