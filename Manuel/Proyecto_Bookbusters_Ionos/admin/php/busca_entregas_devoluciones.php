...
?>
                        <tr>
                                ...
                                <td>
                                        ...
                                        ?>
                                                <i id="confirm<?php echo $codusu ?>" onclick="confirmacion('<?php echo $Nombre ?>','<?php echo $email ?>')" onmouseover='icono_rojo(confirm<?php echo $codusu ?>)' onmouseleave='icono_negro(confirm<?php echo $codusu ?>)' class="icon solid fa-envelope" style="color:black"></i>
                                        <?php
                                        } else {
                                        ?>
        ...
        if (isset($_POST["enviarmail"])) {
                if (($_POST["enviarmail"]) == "confirmacion") {
                        ...
                        $mensaje = "<h1>Hola, $usuario.<br>El administrador ha gestionado tu reserva, puedes retirarlo mañana</h1>
                                        <br>
                                        <img src='https://bookbusters.es/privado/avatares/Bookbusterscapa.png'>";
                ...
                <p>Hola, $usuario, tú opinión es muy valiosa para nosotros y para otros usuarios.
