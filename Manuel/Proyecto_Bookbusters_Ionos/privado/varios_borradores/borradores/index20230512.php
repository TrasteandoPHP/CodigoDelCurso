...
@keyframes slider {
	...
	<!-- <h1>TOP<span style="font-size:x-large;color:#FF33F0;">busters</span></h1> -->
  ...
  <?php
		//include("./php/funciones.php");
			$rec=recoge();
					...
					echo "<div class='slide' style='text-align:center;height:480px'>
					
					<img src='./../images/portadas/"
					.$tempimg.
					"' alt='' style='width:50%;border-radius:5px;margin-left:25%;margin-top:5px'>
